...
class Server(object):
	def __init__(self):
		self.e = 65537
		self.n, self.d = utils.gen_private_key(768, self.e)
		message = PKCS1_v1_5_Pad("kick it, CC, testestemnajehsvgrjejjeijakjshdkajshdkajsdhkasjdhaksjdhaksjdhaksjdhaksj", 768 / 8)
